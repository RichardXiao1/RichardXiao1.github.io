...
library(rmarkdown)
library(tibble)
rmarkdown::render("HW4 blog.Rmd", output_format = github_document(html_preview = FALSE,
  keep_html = FALSE
), output_dir = "C:/Users/rcxia/OneDrive/Documents/ST558githubblogrepo/RichardXiao1.github.io/_posts", output_options = list(toc = TRUE , toc_depth = 3, number_sections = TRUE, keep_html = FALSE, df_print = "tibble")) 
library(knitr)
...
plot(iris)
```
```{r image, echo=FALSE, out.width = "25%", fig.align="center" }
knitr::include_graphics("C:/Users/rcxia/OneDrive/Documents/ST558githubblogrepo/RichardXiao1.github.io/_posts/HW4-blog_files/figure-gfm/iris-1.png")

...
library(rmarkdown)
library(tibble)
rmarkdown::render("HW4 blog.Rmd", output_format = "github_document", output_dir = "_posts", output_options = list(toc = TRUE , toc_depth = 3, number_sections = TRUE, html_preview = FALSE, df_print = "tibble")) 
